...
<body>
  ...
  <section class="secao-topo">
    <div class="topo-container">
      ...
      <p class="topo-subtitulo">Alugue ou compre imóveis de forma fácil, rápida e segura com a <strong
          class="space-negrito"> SPACE FINDER</strong>.</p>
      ...
      <div class="grade-cards">
        <?php if (!empty($imoveis_encontrados)): ?>
          <?php foreach ($imoveis_encontrados as $row): ?>
            <div class="cards"
              onclick="verDetalhes(<?php echo $row['id_casa']; ?>, '<?php echo $row['tipo_transacao']; ?>')">
              <div class="imagem-cards">
                <img src="<?php echo htmlspecialchars($row['foto']); ?>" alt="Imagem do imóvel" class="img-cards" />
                <div
                  class="etiqueta-cards <?php echo ($row['tipo_transacao'] == 'alugar') ? 'etiqueta-alugar' : 'etiqueta-comprar'; ?>">

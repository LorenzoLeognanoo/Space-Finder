...
<head>
  ...
  <title>Space Finder - Comprar</title>
  ...
  <section class="card-principal">
    <div>
      ...
      <form class="search-box" method="GET" action="comprar.php">
        <input type="text" name="q" placeholder="Digite uma localização ou tipo de imóvel..."
          ...
          <div class="grade-filtros">
              ...
              <select name="bairro" id="bairro">
                ...
                <?php if ($bairros_result && $bairros_result->num_rows > 0): ?>
                  <?php while ($row = $bairros_result->fetch_assoc()): ?>
                    <option value="<?php echo htmlspecialchars($row['bairro']); ?>" <?php echo ($bairro == $row['bairro']) ? 'selected' : ''; ?>>
              ...
              <select name="tipo" id="tipo">
                ...
                <?php if ($tipos_result && $tipos_result->num_rows > 0): ?>
                  <?php while ($row = $tipos_result->fetch_assoc()): ?>
                    <option value="<?php echo htmlspecialchars($row['tipo']); ?>" <?php echo ($tipo == $row['tipo']) ? 'selected' : ''; ?>>
              ...
              <select name="num_comodos" id="num_comodos">
                ...
                <?php if ($comodos_result && $comodos_result->num_rows > 0): ?>
                  <?php while ($row = $comodos_result->fetch_assoc()): ?>
                    <option value="<?php echo $row['num_comodos']; ?>" <?php echo ($comodos == $row['num_comodos']) ? 'selected' : ''; ?>>
            ...
            <div class="grupo-filtro">
              ...
              <select name="faixa_preco" id="faixa_preco">
                ...
                <option value="1000-2000" <?php echo ($faixa_preco == '1000-2000') ? 'selected' : ''; ?>>R$ 1.000 - R$
                  2.000</option>
                <option value="2000-3000" <?php echo ($faixa_preco == '2000-3000') ? 'selected' : ''; ?>>R$ 2.000 - R$
                  3.000</option>
                <option value="3000-5000" <?php echo ($faixa_preco == '3000-5000') ? 'selected' : ''; ?>>R$ 3.000 - R$
                  5.000</option>
                <option value="5000-10000" <?php echo ($faixa_preco == '5000-10000') ? 'selected' : ''; ?>>R$ 5.000 - R$
                  10.000</option>
                <option value="10000-999999" <?php echo ($faixa_preco == '10000-999999') ? 'selected' : ''; ?>>Acima de R$
                  10.000</option>
              </select>
            </div>
            ...
            <div class="acoes-filtros">
              ...
              <a href="comprar.php" class="botao-limpar">
            ...
            <div class="cards-imovel" onclick="verDetalhes(<?php echo $row['id_casa']; ?>)">
              ...
              <div class="conteudo-cards">
                ...
                <div class="localizacao-cards">
                  <i class="fas fa-map-marker-alt"></i>
                  <?php echo htmlspecialchars($row['bairro']); ?>    <?php if (!empty($row['rua'])): ?> -
                    <?php echo htmlspecialchars($row['rua']); ?>    <?php endif; ?>
                </div>
                ...
                <div class="caracteristicas-cards">
                  ...
                  <div class="caracteristica">
                    <i class="fas fa-bed"></i>
                    <span><?php echo intval($row['quarto']); ?>
                      Quarto<?php echo intval($row['quarto']) > 1 ? 's' : ''; ?></span>
                  </div>

                  <div class="caracteristica">
                    <i class="fas fa-bath"></i>
                    <span><?php echo intval($row['banheiro']); ?>
                      Banheiro<?php echo intval($row['banheiro']) > 1 ? 's' : ''; ?></span>
                  </div>
